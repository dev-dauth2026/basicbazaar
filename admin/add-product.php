        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4 pb-5 vh-100 overflow-scroll">
                ...
                <div class="mt-4 w-50 mx-auto p-5 shadow">
                        ...
                        <form class="d-flex flex-column gap-3" enctype="multipart/form-data" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']) ?>">
                        <?php ActionMessage() ?>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="productPrice" name="product_price" placeholder="Enter product price">
                            </div>
                            ...
                            <div class="form-group">
                            <label for="productBrand">Product Category</label>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" id="image1" name="product_image1" >
                            </div>
                            <div class="form-group">
